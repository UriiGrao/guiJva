 ...
 * @author uriigrao
 */
public class AltaPartitura extends javax.swing.JDialog {

    /**
     * Creates new form AltaPartitura
     */
    public AltaPartitura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AltaPartitura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AltaPartitura dialog = new AltaPartitura(new javax.swing.JFrame(), true);
